...
$result = pg_query_params($conn, "SELECT DISTINCT id_releve FROM sh.releve_phyto WHERE site=$1 AND annee=$2 AND plot=$3 AND transect=$4 ORDER BY id_releve", [$site, $annee, $plot, $transect]);
$data = [];
