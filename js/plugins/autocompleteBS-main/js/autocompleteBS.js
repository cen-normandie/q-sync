...
function handleInputBS(e, config) {
  ...
  if(config.ajax) {
            ...
            method = 'POST',
            //config.url = '../../../../php/ajax/autocompleteBS.ajax.js.php';
            
            xmlhttp.open(method, config.ajaxurl, true);
            xmlhttp.onerror = function () {
                console.log("** An error occurred during the transaction");
            };
            xmlhttp.onreadystatechange = function() { //Appelle une fonction au changement d'état.
