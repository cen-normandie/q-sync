        ...
        <div class="d-flex flex-column justify-content-end" style="">
            <div class="d-flex flex-column w-100">
                ...
                <div class="d-flex w-100 p-2">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">faune (obs_faune) <button id="w_obs_faune" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">flore (obs_flore) <button id="w_obs_flore" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">carré contact (obs_cc) <button id="w_obs_cc" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">liste des observateurs (observateurs) <button id="w_observateurs" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">liste des taxons faune (tx_faune) <button id="w_tx_faune" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">liste des taxons flore (tx_flore) <button id="w_tx_flore" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">JDD faune (jdd_faune) <button id="w_jdd_faune" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">JDD flore (jdd_flore) <button id="w_jdd_flore" type="button" class="btn btn-dark"><i class="fas fa-file-import text-dark px-1 fs-4"></i></button></li>
                    </ul>
