                    ...
                    <div class="d-flex flex-column col-sm-6 col-md-4 col-lg-3">
                        ...
                        <div class="d-flex flex-column w-100">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">carre contact (obs_cc)                     <button id="w_obs_cc" table="obs_cc" gpkg="observations.gpkg" type="button" class="btn btn-dark"><i class="fas fa-retweet text-light px-1 fs-5"></i></button></li>
